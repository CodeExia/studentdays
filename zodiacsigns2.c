...
int main()
{
    ...
    if (inputmonth >= 1 && inputmonth <= 12)
    {
        if (inputmonth == 1)
        {
            ...
            {
                printf("%s you are a Aquarius!\n", name);
                return 0;
            }
            else if (inputday >= 1 && inputday <= 19)
            {
                printf("%s you are a Capricornus!\n", name);
                return 0;
            }
            else
            {
        ...
        else if (inputmonth == 11)
        {
            ...
            {
                printf("%s you are a Sagittarius!\n", name);
                return 0;
            }
            else
            {
